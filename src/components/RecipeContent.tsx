...
const RecipeContent = ({ recipe }: { recipe: any }) => {
  ...
  return (
    <div>
      ...
      <div className="m-16 p-4 grid grid-cols-4 gap-4" style={{ marginTop: `${marginTopValue}px`}}>
        ...
        <div className="col-span-3">
          ...
          <p className="font-secondary">{recipe.recipe.instructions}</p>
        </div>
      </div>
    </div>
  );
